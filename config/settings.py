"""
Django settings for Konsilium project.
"""
...
# Python 3.14 compatibility shim for Django template Context copy
if sys.version_info >= (3, 14):
    # Import applies monkey-patch on import
    try:
        from . import py314_compat  # noqa: F401
    except Exception:
        pass
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/hour',
        'user': '1000/hour',
        'ai_service': '50/hour',  # More restrictive for AI endpoints
    },
}
